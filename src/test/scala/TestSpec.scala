...
class TestSpec extends AnyWordSpec with Matchers {
  ...
  "Text Formatter" should {
    ...
    "properly format text given a char limit of 40" in {
      ...
      forAll(result) { line =>
        println(line)
        assert(line.length <= charLimit)
      }

      assert(result.nonEmpty)
    }

    "properly format text given a char limit of 10" in {
    ...
    "return an empty List given an impossible char limit for the text provided" in {
    ...
    "return an empty List given a negative char limit" in {
    ...
    "return an empty List given a word is present that does not fit the char limit" in {
    ...
    "properly format text given a char limit of 1000" in {
